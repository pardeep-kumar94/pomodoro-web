    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center px-6 py-12">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Log in to continue your productivity journey</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center">
                <input type="checkbox" className="rounded text-[#ff9d5c] mr-2" />
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link href="/signup" className="text-[#ff9d5c] hover:text-[#ff8040] font-medium">
              Sign up for free
            </Link>
          </p>
        </div>
